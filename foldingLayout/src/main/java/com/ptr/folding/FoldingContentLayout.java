...
public class FoldingContentLayout extends ViewGroup {
    ...
    private void calculateMatrices() {
        ...
        float translatedDistancePerFold = Math.round(translatedDistance
                / mNumberOfFolds);
        Log.e("tag", "mAnchorFactor: " + mAnchorFactor );
        Log.e("tag", "translatedDistance: " + translatedDistance + " translatedDistancePerFold: " + translatedDistancePerFold);
        ...
        for (int x = 0; x < mNumberOfFolds; x++) {
            ...
            Log.e("tag", Arrays.toString(mDst));
